...
namespace model_Hier_PP_fixed_hnormal_pbpp_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Hier_PP_fixed_hnormal_pbpp");
    reader.add_event(63, 61, "end", "model_Hier_PP_fixed_hnormal_pbpp");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Hier_PP_fixed_hnormal_pbpp
  : public stan::model::model_base_crtp<model_Hier_PP_fixed_hnormal_pbpp> {
private:
        int N0;
        int J0;
        int N;
        ...
        double a_0;
public:
    model_Hier_PP_fixed_hnormal_pbpp(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Hier_PP_fixed_hnormal_pbpp_namespace::model_Hier_PP_fixed_hnormal_pbpp";
    ...
    ~model_Hier_PP_fixed_hnormal_pbpp() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add((normal_log(sigma_eta0, 0, sigma_b_prior) - normal_ccdf_log(0, 0, sigma_b_prior)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Hier_PP_fixed_hnormal_pbpp_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_Hier_PP_fixed_hnormal_pbpp";
    }
...
typedef model_Hier_PP_fixed_hnormal_pbpp_namespace::model_Hier_PP_fixed_hnormal_pbpp stan_model;
#ifndef USING_R
