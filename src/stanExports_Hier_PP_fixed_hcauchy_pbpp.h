...
namespace model_Hier_PP_fixed_hcauchy_pbpp_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Hier_PP_fixed_hcauchy_pbpp");
    reader.add_event(63, 61, "end", "model_Hier_PP_fixed_hcauchy_pbpp");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Hier_PP_fixed_hcauchy_pbpp
  : public stan::model::model_base_crtp<model_Hier_PP_fixed_hcauchy_pbpp> {
private:
        int N0;
        int J0;
        int N;
        ...
        double a_0;
public:
    model_Hier_PP_fixed_hcauchy_pbpp(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Hier_PP_fixed_hcauchy_pbpp_namespace::model_Hier_PP_fixed_hcauchy_pbpp";
        ...
        try {
            ...
            validate_non_negative_index("Trt0", "N0", N0);
            context__.validate_dims("data initialization", "Trt0", "vector_d", context__.to_vec(N0));
            Trt0 = Eigen::Matrix<double, Eigen::Dynamic, 1>(N0);
            vals_r__ = context__.vals_r("Trt0");
            pos__ = 0;
            size_t Trt0_j_1_max__ = N0;
            for (size_t j_1__ = 0; j_1__ < Trt0_j_1_max__; ++j_1__) {
                Trt0(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 12;
            validate_non_negative_index("X0", "N0", N0);
            validate_non_negative_index("X0", "(P - 1)", (P - 1));
            context__.validate_dims("data initialization", "X0", "matrix_d", context__.to_vec(N0,(P - 1)));
            X0 = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(N0, (P - 1));
            vals_r__ = context__.vals_r("X0");
            pos__ = 0;
            size_t X0_j_2_max__ = (P - 1);
            ...
            context__.validate_dims("data initialization", "a_0", "double", context__.to_vec());
            a_0 = double(0);
            vals_r__ = context__.vals_r("a_0");
            pos__ = 0;
            a_0 = vals_r__[pos__++];
            check_greater_or_equal(function__, "a_0", a_0, 0);
            check_less_or_equal(function__, "a_0", a_0, 1);
    ...
    ~model_Hier_PP_fixed_hcauchy_pbpp() { }
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 29;
        if (!(context__.contains_r("sigma_eta0")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sigma_eta0 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sigma_eta0");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "sigma_eta0", "double", context__.to_vec());
        double sigma_eta0(0);
        sigma_eta0 = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, sigma_eta0);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sigma_eta0: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 30;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 29;
            local_scalar_t__ sigma_eta0;
            (void) sigma_eta0;  // dummy to suppress unused var warning
            if (jacobian__)
                sigma_eta0 = in__.scalar_lb_constrain(0, lp__);
            else
                sigma_eta0 = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 30;
            ...
            stan::math::assign(eta0,multiply(sigma_eta0, eta0_raw));
            ...
            stan::math::assign(mu0,add(add(add(stan::model::rvalue(eta0, stan::model::cons_list(stan::model::index_multi(Z0), stan::model::nil_index_list()), "eta0"), alpha0), multiply(Trt0, get_base1(beta, 1, "beta", 1))), multiply(X0, stan::model::rvalue(beta0, stan::model::cons_list(stan::model::index_min_max(2, P), stan::model::nil_index_list()), "beta0"))));
            ...
            lp_accum__.add((a_0 * normal_log(y0, mu0, sigma0)));
            ...
            lp_accum__.add(normal_log(alpha0, intercept_prior_mean, intercept_prior_sd));
            ...
            for (int p = 1; p <= P; ++p) {
                ...
                lp_accum__.add(normal_log(get_base1(beta0, p, "beta0", 1), get_base1(reg_prior_mean, p, "reg_prior_mean", 1), get_base1(reg_prior_sd, p, "reg_prior_sd", 1)));
            }
            current_statement_begin__ = 54;
            lp_accum__.add(exponential_log(sigma, sigma_prior));
            current_statement_begin__ = 55;
            lp_accum__.add(exponential_log(sigma0, sigma_prior));
            current_statement_begin__ = 56;
            lp_accum__.add((cauchy_log(sigma_eta, 0, sigma_b_prior) - cauchy_ccdf_log(0, 0, sigma_b_prior)));
            current_statement_begin__ = 57;
            lp_accum__.add((cauchy_log(sigma_eta0, 0, sigma_b_prior) - cauchy_ccdf_log(0, 0, sigma_b_prior)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Hier_PP_fixed_hcauchy_pbpp_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double sigma_eta0 = in__.scalar_lb_constrain(0);
        vars__.push_back(sigma_eta0);
    ...
    std::string model_name() const {
        return "model_Hier_PP_fixed_hcauchy_pbpp";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "sigma_eta0";
        param_names__.push_back(param_name_stream__.str());
        size_t beta_j_1_max__ = P;
        for (size_t j_1__ = 0; j_1__ < beta_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
...
typedef model_Hier_PP_fixed_hcauchy_pbpp_namespace::model_Hier_PP_fixed_hcauchy_pbpp stan_model;
#ifndef USING_R
