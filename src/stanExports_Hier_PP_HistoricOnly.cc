...
#include "stanExports_Hier_PP_HistoricOnly.h"

RCPP_MODULE(stan_fit4Hier_PP_HistoricOnly_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_Hier_PP_HistoricOnly")
