...
namespace model_Hier_PP_hcauchy_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Hier_PP_hcauchy");
    reader.add_event(85, 83, "end", "model_Hier_PP_hcauchy");
    return reader;
}
...
class model_Hier_PP_hcauchy
  : public stan::model::model_base_crtp<model_Hier_PP_hcauchy> {
private:
        int N0;
        int J0;
        int N;
...
public:
    model_Hier_PP_hcauchy(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Hier_PP_hcauchy_namespace::model_Hier_PP_hcauchy";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Hier_PP_hcauchy_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Hier_PP_hcauchy_namespace::model_Hier_PP_hcauchy stan_model;
#ifndef USING_R
