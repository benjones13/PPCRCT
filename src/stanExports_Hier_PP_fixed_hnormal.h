...
namespace model_Hier_PP_fixed_hnormal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Hier_PP_fixed_hnormal");
    reader.add_event(58, 56, "end", "model_Hier_PP_fixed_hnormal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Hier_PP_fixed_hnormal
  : public stan::model::model_base_crtp<model_Hier_PP_fixed_hnormal> {
private:
        int N0;
        int J0;
        int N;
        ...
        double a_0;
public:
    model_Hier_PP_fixed_hnormal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Hier_PP_fixed_hnormal_namespace::model_Hier_PP_fixed_hnormal";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(exponential_log(sigma_prior, 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Hier_PP_fixed_hnormal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_Hier_PP_fixed_hnormal";
    }
...
typedef model_Hier_PP_fixed_hnormal_namespace::model_Hier_PP_fixed_hnormal stan_model;
#ifndef USING_R
