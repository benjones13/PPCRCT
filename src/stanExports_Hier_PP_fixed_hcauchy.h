...
namespace model_Hier_PP_fixed_hcauchy_namespace {
using std::istream;
using std::string;
...
class model_Hier_PP_fixed_hcauchy
  : public stan::model::model_base_crtp<model_Hier_PP_fixed_hcauchy> {
private:
        int N0;
        int J0;
        int N;
        ...
        double a_0;
public:
    model_Hier_PP_fixed_hcauchy(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Hier_PP_fixed_hcauchy_namespace::model_Hier_PP_fixed_hcauchy";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Hier_PP_fixed_hcauchy_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_Hier_PP_fixed_hcauchy";
    }
...
typedef model_Hier_PP_fixed_hcauchy_namespace::model_Hier_PP_fixed_hcauchy stan_model;
#ifndef USING_R
