...
#include "stanExports_Hier_PP_fixed_hcauchy.h"

RCPP_MODULE(stan_fit4Hier_PP_fixed_hcauchy_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_Hier_PP_fixed_hcauchy")
