#' Fit the Fixed Discounting Power Prior in Stan
#'
#' FDPP_modelfit is a modularised function contained within \link[PPCRCT]{FDPP} function, which fits the Fixed Discount Power Prior (i.e. information borrowing from all parameters) in Stan.
#' 
